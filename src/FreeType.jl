...
const FT_LOAD_DEFAULT = @compat Int32(0)
const FT_LOAD_TARGET_NORMAL = @compat Int32(0)
const FT_LOAD_NO_SCALE = @compat Int32(1 << 0)
const FT_LOAD_NO_HINTING = @compat Int32(1 << 1)
const FT_LOAD_RENDER = @compat Int32(1 << 2)
const FT_LOAD_NO_BITMAP = @compat Int32(1 << 3)
const FT_LOAD_VERTICAL_LAYOUT = @compat Int32(1 << 4)
const FT_LOAD_FORCE_AUTOHINT = @compat Int32(1 << 5)
const FT_LOAD_CROP_BITMAP = @compat Int32(1 << 6)
const FT_LOAD_PEDANTIC = @compat Int32(1 << 7)
const FT_LOAD_ADVANCE_ONLY = @compat Int32(1 << 8)
const FT_LOAD_IGNORE_GLOBAL_ADVANCE_WIDTH = @compat Int32(1 << 9)
const FT_LOAD_NO_RECURSE = @compat Int32(1 << 10)
const FT_LOAD_IGNORE_TRANSFORM = @compat Int32(1 << 11)
const FT_LOAD_MONOCHROME = @compat Int32(1 << 12)
const FT_LOAD_LINEAR_DESIGN = @compat Int32(1 << 13)
const FT_LOAD_SBITS_ONLY = @compat Int32(1 << 14)
const FT_LOAD_NO_AUTOHINT = @compat Int32(1 << 15)
const FT_LOAD_TARGET_LIGHT = @compat Int32(1 << 16)
const FT_LOAD_TARGET_MONO = @compat Int32(1 << 17)
const FT_LOAD_TARGET_LCD = @compat Int32(196608)
const FT_LOAD_TARGET_LCD_V = @compat Int32(1 << 18)
const FT_LOAD_COLOR = @compat Int32(1 << 20)

const FT_FACE_FLAG_SCALABLE         = @compat Int32(1 <<  0)
const FT_FACE_FLAG_FIXED_SIZES      = @compat Int32(1 <<  1)
const FT_FACE_FLAG_FIXED_WIDTH      = @compat Int32(1 <<  2)
const FT_FACE_FLAG_SFNT             = @compat Int32(1 <<  3)
const FT_FACE_FLAG_HORIZONTAL       = @compat Int32(1 <<  4)
const FT_FACE_FLAG_VERTICAL         = @compat Int32(1 <<  5)
const FT_FACE_FLAG_KERNING          = @compat Int32(1 <<  6)
const FT_FACE_FLAG_FAST_GLYPHS      = @compat Int32(1 <<  7)
const FT_FACE_FLAG_MULTIPLE_MASTERS = @compat Int32(1 <<  8)
const FT_FACE_FLAG_GLYPH_NAMES      = @compat Int32(1 <<  9)
const FT_FACE_FLAG_EXTERNAL_STREAM  = @compat Int32(1 << 10)
const FT_FACE_FLAG_HINTER           = @compat Int32(1 << 11)
const FT_FACE_FLAG_CID_KEYED        = @compat Int32(1 << 12)
const FT_FACE_FLAG_TRICKY           = @compat Int32(1 << 13)
...
const FT_PIXEL_MODE_GRAY2 = @compat UInt32(3)
const FT_PIXEL_MODE_GRAY4 = @compat UInt32(4)
const FT_PIXEL_MODE_LCD = @compat UInt32(5)
const FT_PIXEL_MODE_LCD_V = @compat UInt32(6)
const FT_PIXEL_MODE_BGRA = @compat UInt32(7)
const FT_PIXEL_MODE_MAX = @compat UInt32(8)
...
const FT_Mod_Err_Bzip2 = @compat UInt32(0)
const FT_Mod_Err_Cache = @compat UInt32(0)
const FT_Mod_Err_CFF = @compat UInt32(0)
const FT_Mod_Err_CID = @compat UInt32(0)
const FT_Mod_Err_Gzip = @compat UInt32(0)
const FT_Mod_Err_LZW = @compat UInt32(0)
const FT_Mod_Err_OTvalid = @compat UInt32(0)
const FT_Mod_Err_PCF = @compat UInt32(0)
const FT_Mod_Err_PFR = @compat UInt32(0)
const FT_Mod_Err_PSaux = @compat UInt32(0)
const FT_Mod_Err_PShinter = @compat UInt32(0)
const FT_Mod_Err_PSnames = @compat UInt32(0)
const FT_Mod_Err_Raster = @compat UInt32(0)
const FT_Mod_Err_SFNT = @compat UInt32(0)
const FT_Mod_Err_Smooth = @compat UInt32(0)
const FT_Mod_Err_TrueType = @compat UInt32(0)
const FT_Mod_Err_Type1 = @compat UInt32(0)
const FT_Mod_Err_Type42 = @compat UInt32(0)
const FT_Mod_Err_Winfonts = @compat UInt32(0)
const FT_Mod_Err_GXvalid = @compat UInt32(0)
const FT_Mod_Err_Max = @compat UInt32(1)
...
const FT_ENCODING_SJIS = @compat UInt32(1936353651)
const FT_ENCODING_GB2312 = @compat UInt32(1734484000)
const FT_ENCODING_BIG5 = @compat UInt32(1651074869)
const FT_ENCODING_WANSUNG = @compat UInt32(2002873971)
const FT_ENCODING_JOHAB = @compat UInt32(1785686113)
const FT_ENCODING_MS_SJIS = @compat UInt32(1936353651)
const FT_ENCODING_MS_GB2312 = @compat UInt32(1734484000)
const FT_ENCODING_MS_BIG5 = @compat UInt32(1651074869)
const FT_ENCODING_MS_WANSUNG = @compat UInt32(2002873971)
const FT_ENCODING_MS_JOHAB = @compat UInt32(1785686113)
const FT_ENCODING_ADOBE_STANDARD = @compat UInt32(1094995778)
const FT_ENCODING_ADOBE_EXPERT = @compat UInt32(1094992453)
const FT_ENCODING_ADOBE_CUSTOM = @compat UInt32(1094992451)
const FT_ENCODING_ADOBE_LATIN_1 = @compat UInt32(1818326065)
